            ...
            {menuItems.map((item) => (
              ...
              >
                <div className="flex items-center gap-1">
                   <span className={`px-2 py-1 transition-all rounded-full ${scrolled ? "hover:bg-black hover:text-white" : "hover:bg-white hover:text-black"}`}>
                ...
                {item.isMega && (
                  <div
                    className={`absolute left-1/2 -translate-x-1/2 top-full mt-2 w-[850px] bg-white rounded-[32px] p-8 shadow-2xl text-black transition-all duration-300 transform origin-top ${
                      isServicesHovered ? "opacity-100 scale-100 visible" : "opacity-0 scale-95 invisible"
                    }`}
                  >
                    <div className="grid grid-cols-12 gap-8 text-left">
                      <div className="col-span-8">
                        <p className="text-xs uppercase font-bold text-gray-400 mb-6">Core Services</p>
                      ...
                      <div className="col-span-4 relative rounded-2xl overflow-hidden bg-gray-100 flex flex-col justify-end p-5 group/card">
                        ...
                        <div className="relative z-10 text-center w-full">
                          ...
                          <button className="bg-black text-white text-[10px] font-black px-4 py-2 rounded-full uppercase">
        ...
        <div className="w-full h-full bg-[#1a1c1e] flex flex-col p-8 overflow-y-auto">
          <div className="flex justify-between items-center mb-10">
            ...
            <button
              ...
              className="text-white p-3 border border-white/20 rounded-full"
            >
              <X size={24} />
            </button>
          </div>
          ...
          <nav className="flex flex-col space-y-6">
            {["Services", "International", "About", "Work", "Careers", "Blog", "Webinar"].map((name) => (
              <div key={name} className="flex items-center justify-between py-2 border-b border-white/5">
                <a href="#" className="text-4xl font-black text-white uppercase tracking-tighter hover:text-[#b2f9e1] transition-colors">
                  {name}
                </a>
            ...
            <div className="pt-10">
              <button className="w-full bg-[#b2f9e1] text-black py-5 rounded-full font-black text-lg">
                Get In Touch ↗
              </button>
            </div>
          </nav>
